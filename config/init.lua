...
config.set_keybinds({
    ...
    {"mod-C-1",       print("works")},
    {"mod-C-2",       function() action.move_workspace_to(1) end},
    {"mod-C-3",       function() action.move_workspace_to(2) end},
    {"mod-C-4",       function() action.move_workspace_to(3) end},
    {"mod-C-5",       function() action.move_workspace_to(4) end},
    {"mod-C-6",       function() action.move_workspace_to(5) end},
    {"mod-C-7",       function() action.move_workspace_to(6) end},
    {"mod-C-8",       function() action.move_workspace_to(7) end},
    {"mod-C-9",       function() action.move_workspace_to(8) end},
