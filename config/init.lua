...
config.set_keybinds({
    ...
    {"mod-C-1",     function() action.tag_view(1 << 0) end},
    {"mod-C-2",     function() action.tag_view(1 << 1) end},
    {"mod-C-3",     function() action.tag_view(1 << 2) end},
    {"mod-C-4",     function() action.tag_view(1 << 3) end},
    {"mod-C-5",     function() action.tag_view(1 << 4) end},
    {"mod-C-6",     function() action.tag_view(1 << 5) end},
    {"mod-C-7",     function() action.tag_view(1 << 6) end},
    {"mod-C-8",     function() action.tag_view(1 << 7) end},
    {"mod-C-9",     function() action.tag_view(1 << 8) end},
    -- {"mod-C-1",       function() action.swap_workspace(info.get_workspace(), 1 << 0) end},
