...
keys = {
    ...
    {mod.." 3",           function(n) action.view(3) end},
    {mod.." 4",           function(n) action.view(4) end},
    {mod.." 5",           function(n) action.view(5) end},
    {mod.." 6",           function(n) action.view(6) end},
    {mod.." 7",           function(n) action.view(7) end},
    {mod.." 8",           function(n) action.view(8) end},
    {mod.." 9",           function(n) action.view(9) end},
    {mod.." "..shift.." 1",    function(n) action.toggleAddView(1) end},
    {mod.." "..shift.." 2",    function(n) action.toggleAddView(2) end},
    {mod.." "..shift.." 3",    function(n) action.toggleAddView(3) end},
    {mod.." "..shift.." 4",    function(n) action.toggleAddView(4) end},
    {mod.." "..shift.." 5",    function(n) action.toggleAddView(5) end},
    {mod.." "..shift.." 6",    function(n) action.toggleAddView(6) end},
    {mod.." "..shift.." 7",    function(n) action.toggleAddView(7) end},
    {mod.." "..shift.." 8",    function(n) action.toggleAddView(8) end},
    {mod.." "..shift.." 9",    function(n) action.toggleAddView(9) end},
