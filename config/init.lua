...
Keys = {
    ...
    {Mod.." "..Shift.." h",        function() Resize_main_all(-1/10, Resize_direction) end},
    {Mod.." "..Shift.." l",        function() Resize_main_all(1/10, Resize_direction) end},
    ...
    {Mod.." "..Shift.." 1",             function() action.move_container_to_workspace(0) end},
    {Mod.." "..Shift.." 2",             function() action.move_container_to_workspace(1) end},
    {Mod.." "..Shift.." 3",             function() action.move_container_to_workspace(2) end},
    {Mod.." "..Shift.." 4",             function() action.move_container_to_workspace(3) end},
    {Mod.." "..Shift.." 5",             function() action.move_container_to_workspace(4) end},
    {Mod.." "..Shift.." 6",             function() action.move_container_to_workspace(5) end},
    {Mod.." "..Shift.." 7",             function() action.move_container_to_workspace(6) end},
    {Mod.." "..Shift.." 8",             function() action.move_container_to_workspace(7) end},
    {Mod.." "..Shift.." 9",             function() action.move_container_to_workspace(8) end},
