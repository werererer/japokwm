...
keys = {
    ...
    {mod.." "..shift.." 1",    function(n) action.toggleAddView(0) end},
    {mod.." "..shift.." 2",    function(n) action.toggleAddView(1) end},
    {mod.." "..shift.." 3",    function(n) action.toggleAddView(2) end},
    {mod.." "..shift.." 4",    function(n) action.toggleAddView(3) end},
    {mod.." "..shift.." 5",    function(n) action.toggleAddView(4) end},
    {mod.." "..shift.." 6",    function(n) action.toggleAddView(5) end},
    {mod.." "..shift.." 7",    function(n) action.toggleAddView(6) end},
    {mod.." "..shift.." 8",    function(n) action.toggleAddView(7) end},
    {mod.." "..shift.." 9",    function(n) action.toggleAddView(8) end},
