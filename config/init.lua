...
config.bind_key("mod-0",         function() action.set_tags(1 << container.get_workspace(info.this_container_position())) end)
...
config.bind_key("mod-C-0",       function() action.set_tags(1 << info.get_workspace()) end)
