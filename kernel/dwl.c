...
static uint32_t cleanmask(uint32_t mask);
...
buttonpress(struct wl_listener *listener, void *data)
{
    ...
    /*     /1* If you released any buttons, we exit interactive move/resize mode. *1/ */
    /*     /1* XXX should reset to the pointer focus's current setcursor *1/ */
    /*     if (cursor_mode != CurNormal) { */
    /*         wlr_xcursor_manager_set_cursor_image(cursor_mgr, */
    /*                 "left_ptr", cursor); */
    /*         cursor_mode = CurNormal; */
    /*         /1* Drop the window off on its new monitor *1/ */
    ...
    /*     break; */
    /* } */
    /* /1* If the event wasn't handled by the compositor, notify the client with */
    /*  * pointer focus that a button press has occurred *1/ */
