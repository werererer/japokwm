...
# 0.4 = height
=#
function readContainers(file :: String) :: Array{Layouts.Container}
    res = []
    ...
    for i in 1:size(arr)[1]
        push!(res, Layouts.Container(arr[i,1], arr[i,2], arr[i,3], arr[i,4]))
    end
    return res
end
...
# visible.
=#
function getLayout(layout :: String) :: Array{Array{Layouts.Container, 1}, 1}
